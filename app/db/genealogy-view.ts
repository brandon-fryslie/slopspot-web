...
import { PostId, type Genealogy, type GenealogyNode, type Media } from '~/lib/domain'
...
export async function getGenealogy(env: Env, postId: PostId): Promise<Genealogy> {
  ...
  // a genome) — and fails loud rather than vanishing into a blank tile. [LAW:no-silent-fallbacks]
